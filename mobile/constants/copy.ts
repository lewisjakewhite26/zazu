...
export const copy = {
  ...
  settings: {
    ...
    deleteAccountConfirmBody:
      'This permanently deletes your streak, coins, word progress, and Gold entitlement. This cannot be undone.',
  ...
  a11y: {
    ...
    exitDemoAlarm: 'Exit demo alarm',
    correctAnnouncement: 'Correct.',
    dismissingAlarmAnnouncement: 'Dismissing alarm…',
    canDismissAlarmAnnouncement: 'You can now dismiss the alarm.',
  },
  calendar: {
    title: 'Vocabulary',
