...
15. **Write and host a Privacy Policy + Terms of Service (#49)** — blocks App Store/Play Store submission. Needs a hosting decision (static page on the Vercel deploy? a dedicated doc host?) and sign-off on the actual legal content, not just a draft.
16. **Write an Accessibility statement (#50)** — not a submission blocker, lower priority than #49.
